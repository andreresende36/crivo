...
from crivo.distributor.affiliate_links import AffiliateLinkBuilder
from crivo.distributor.message_formatter import MessageFormatter
from crivo.distributor.telegram_bot import TelegramBot
...
async def send_next_offer(
    ...
    if custom_body:
        ...
        from crivo.distributor.message_formatter import FormattedMessage
        ...
        if not catchy_title and settings.openrouter.api_key:
            from crivo.distributor.title_generator import generate_catchy_title
            try:
    ...
    from crivo.distributor.message_validator import validate_message
    validate_message(
